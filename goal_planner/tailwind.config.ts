...
export default {
  darkMode: ["class"],
  content: ["./app/**/*.{ts,tsx}", "./containers/**/*.{ts,tsx}", "./components/**/*.{ts,tsx}"],
  prefix: "",
  theme: {
    container: {
      center: true,
    ...
    extend: {
      ...
      fontFamily: {
        ...
        'abeezee': ['ABeeZee', '-apple-system', 'Roboto', 'Helvetica', 'sans-serif'],
        sans: ['Inter', '-apple-system', 'Roboto', 'Helvetica', 'sans-serif'],
      },
      backgroundImage: {
        'gradient-orange': 'linear-gradient(90deg, #D94E06 1.84%, #F50 41.66%, #FF8548 105.37%)',
      },
      borderRadius: {
        lg: "var(--radius)",
