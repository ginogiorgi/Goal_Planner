	...
	const [goals, setGoals] = useState([
		{
			...
			tasks: [
				...
				{ title: "Build portfolio website", days: "Tue, Thu", time: "2:00 PM" },
			],
			habits: [
				{ title: "Daily design practice", days: "Everyday", time: "8:00 AM" },
			],
		},
		{
			...
			{currentStep === 1 && (
				<>
					<main className="flex-1 flex flex-col items-center justify-center px-4 md:px-8 lg:px-24 py-4">
						<div className="w-full flex flex-col items-center gap-8">
							...
							<div className="flex flex-col items-center gap-6 text-center">
								<h1 className="font-title font-bold text-3xl md:text-4xl lg:text-5xl leading-[1] tracking-[-0.025em]">
								...
								<p className="font-text font-normal text-base md:text-md leading-[1.4] text-white-pearl max-w-[600px]">
									GoalPlanner helps you organize your life, track your habits,
									and achieve your biggest dreams through a simple, visual, and
					...
					<footer className="px-4 md:px-8 pb-8 flex flex-col items-center gap-4">
						<Button
							onClick={handleNext}
							className="flex items-center justify-center w-full max-w-[384px] h-[64px] text-md leading-[28px] gap-5">
							Start Your Journey
							<TfiArrowRight />
						</Button>
					</footer>
