						...
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
							...
							<div>
								<div className="flex items-center gap-2 mb-3">
									<div className="w-6 h-6 bg-[rgba(255,85,0,0.1)] rounded-[7px] flex items-center justify-center">
										<IoMdTime size={22} className="text-vibrant-orange" />
									</div>
									<h2 className="text-white-pearl font-text font-semibold text-base leading-[22px]">
										Tasks
									</h2>
								</div>
