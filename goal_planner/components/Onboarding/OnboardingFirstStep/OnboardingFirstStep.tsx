	...
	return (
		<div className="min-h-screen bg-deep-bg flex flex-col ">
			...
			<footer className="px-4 md:px-8 pb-8 flex flex-col items-center gap-4">
				<button
					onClick={onNext}
					className="flex items-center justify-center w-full max-w-[384px] h-[64px] bg-vibrant-orange text-white-pearl font-text font-bold text-md leading-[28px] rounded-[7px] shadow-[0px_0px_10px_2px_rgba(217,78,6,0.8)] hover:opacity-90 transition-opacity gap-5">
					Start Your Journey
					<TfiArrowRight />
				</button>
			</footer>
